...
export function SimulationResults({ sim }: { sim: SimData; frequency: Frequency }) {
  ...
  return (
    <div className="mt-6 pt-6 border-t border-border/80 space-y-3">
      ...
      <div className="rounded-xl bg-gradient-to-br from-feedback-success-bg to-feedback-success-bg/50 border border-feedback-success/25 p-4 sm:p-6 shadow-2xs">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 items-center">
          ...
          <div className="space-y-2.5 sm:border-l sm:border-feedback-success/20 sm:pl-5">
            ...
            <div className="pt-1.5 border-t border-feedback-success/20 flex items-center justify-between text-[11px] sm:text-xs text-muted-2">
